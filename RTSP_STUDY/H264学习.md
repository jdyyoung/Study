...
```
1.网络传输的帧：一个NAL单元，帧前面带有00 00 00 01 或 00 00 01分隔符
2.H264 数据帧：在实际的H264数据帧中，往往帧前面带有00 00 00 01 或 00 00 01分隔符，一般来说编码器编出的首帧数据为PPS与SPS，接着为I帧……
3.帧率：每秒数据帧，指I，B,P帧
```
...
基于上下文的二进制算术编码（Context-Based Adaptive Binary Arithmetic Coding,CABAC）

h.264avc标准中可伸缩视频编码的算法研究-research on scalable video coding algorithm in h 264 avc standard.docx - https://max.book118.com/html/2018/0524/168418742.shtm

(3条消息) HEVC Study Three(基于HM14.0平台)--GOP研究之大揭秘_成长Bar的博客专栏-CSDN博客 - https://blog.csdn.net/FRD2009041510/article/details/39965109

(3条消息) H.264协议CABAC熵编码学习(一)_程序の道-CSDN博客 - https://blog.csdn.net/u011875342/article/details/79627194?utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromMachineLearnPai2%7Edefault-16.control&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromMachineLearnPai2%7Edefault-16.control
